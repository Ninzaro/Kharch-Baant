        ...
        <>
                        ...
                        {group && (
                            <div className="flex flex-col gap-2 mb-2">
                                {group.createdBy === currentUserId ? (
                                    <button
                                        type="button"
                                        className="px-3 py-2 bg-red-600/90 hover:bg-red-500 text-foreground text-sm rounded-md disabled:opacity-50"
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <button
                                            type="button"
                                            className="px-3 py-2 bg-yellow-600/90 hover:bg-yellow-500 text-foreground text-sm rounded-md disabled:opacity-50"
            ...
            >
                <form id="group-form" onSubmit={handleSubmit} className="flex-grow overflow-y-auto space-y-4 pr-2">
                    <div>
                        <label htmlFor="group-name" className="block text-sm font-medium text-muted-foreground mb-1">Group Name</label>
                        <input
                            type="text"
                            id="group-name"
                            value={name}
                    ...
                    <div>
                        <label htmlFor="group-type" className="block text-sm font-medium text-muted-foreground mb-1">Group Type</label>
                        <select
                            id="group-type"
                            value={groupType}
                    ...
                    {requiresTripDates(groupType) && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="trip-start" className="block text-sm font-medium text-muted-foreground mb-1">Trip Start Date</label>
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-card border border-border text-foreground rounded-md p-2 pr-10 focus:ring-ring focus:border-ring [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute"
                                    />
                            ...
                            <div>
                                <label htmlFor="trip-end" className="block text-sm font-medium text-muted-foreground mb-1">Trip End Date</label>
                                <div className="relative">
                                    <input
                                        id="trip-end"
                                        type="date"
                    ...
                    <div className="flex items-center justify-between bg-overlay/20 p-3 rounded-md">
                        <div>
                            <label htmlFor="cute-icons-toggle" className="block text-sm font-medium text-muted-foreground">Cute Icons</label>
                            <p className="text-xs text-muted-foreground">Auto-add emojis to expenses (e.g., ✈️ for Travel)</p>
                        </div>
                        <button
                            type="button"
                            id="cute-icons-toggle"
                            onClick={() => setEnableCuteIcons(!enableCuteIcons)}
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-slate-900 ${enableCuteIcons ? 'bg-primary' : 'bg-muted'}`}
                        >
                            <span
                        ...
                        <div className="space-y-3">
                            ...
                            {group && (
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-success/20 text-success rounded-md hover:bg-success/40 transition-colors"
                                >
            ...
            <BaseModal
                ...
                size="sm"
                description={<span className="text-muted-foreground text-sm">Choose how to share the invite link</span>}
            >
                <div className="space-y-3 p-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-4 bg-green-600 hover:bg-green-700 text-foreground rounded-lg transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-4 bg-blue-600 hover:bg-blue-700 text-foreground rounded-lg transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-colors"
                    >
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {navigator.share && (
                        <button
                            ...
                            className="w-full flex items-center gap-3 p-4 bg-muted hover:bg-muted text-foreground rounded-lg transition-colors"
                        >
                    ...
                    <div className="mt-4 p-3 bg-foreground/5 rounded-lg">
                        ...
                        <p className="text-sm text-foreground break-all font-mono">{shareData?.url}</p>
                        <p className="text-xs text-muted-foreground mt-2">Link expires in 30 days</p>
                    </div>
                </div>
            </BaseModal>
        </>
