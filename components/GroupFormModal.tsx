                ...
                <form id="group-form" onSubmit={handleSubmit} className="flex-grow overflow-y-auto space-y-4 pr-2">
                    ...
                    <div className="flex items-center justify-between bg-overlay/20 p-3 rounded-md">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background ${enableCuteIcons ? 'bg-primary' : 'bg-muted'}`}
                        >
                            <span
                                className={`inline-block h-4 w-4 transform rounded-full bg-primary-foreground transition-transform ${enableCuteIcons ? 'translate-x-6' : 'translate-x-1'}`}
                            />
                        </button>
                    </div>
            ...
            >
                <div className="space-y-3 p-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-4 bg-success hover:bg-success/90 text-success-foreground rounded-lg transition-colors"
                    >
