                    ...
                    {Capacitor.isNativePlatform() && (
                      <div className="w-full max-w-sm mb-3">
                        <button
                          ...
                          className="w-full py-2.5 px-4 rounded-xl bg-card border border-border text-foreground font-medium flex items-center justify-center gap-3 hover:bg-card/80 transition-colors shadow-sm"
                        >
