  ...
  <BaseModal
    ...
    footer={
      <div className="flex gap-2">
        <button type="button" onClick={onClose} className="px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80">Not Now</button>
        <button type="button" onClick={onArchive} className="px-4 py-2 bg-warning hover:bg-warning/90 text-warning-foreground rounded-md">Archive Group</button>
      </div>
    }
  >
