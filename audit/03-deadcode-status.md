...
| D-06 | P1 | Email normalisation asymmetry creates permanently unclaimable duplicate people | pending | §9 / §8.3 |
| D-07 | P2 | Canonical docs describe a modal system (`useModals` + `ModalContext`) with zero importers | pending | §9 / §2.5 |
